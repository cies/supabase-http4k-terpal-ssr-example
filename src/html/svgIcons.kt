...
/** This arrow needs to be used with an Alpine data field named `open`. Based on that, it shows the 'expand' or 'collapse' variant. */
val expandOrCollapseMenuGroupArrow = """
...
/** This arrow needs to be used with the Tailwind `sidebar-expanded` prefix. Based on that, it shows the 'expand' or 'collapse' variant. */
val expandOrCollapseSidebarArrow = """
...
fun slidersIcon(isActive: Boolean) = """
  <svg class="shrink-0 fill-current ${if (isActive) "text-violet-500" else "text-gray-400 dark:text-gray-500"}" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
